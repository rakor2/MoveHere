...
SimplePrint = SimplePrinter:New{Prefix = "DH", ApplyColor = true}
function MPrint(...) SimplePrint:SetFontColor(0, 255, 158) SimplePrint:Print(...) end
function MTest(...) SimplePrint:SetFontColor(228, 101, 255) SimplePrint:PrintTest(...) end
function MDebug(...) SimplePrint:SetFontColor(255, 224, 81) SimplePrint:PrintDebug(...) end
function MWarn(...) SimplePrint:SetFontColor(221, 116, 18) SimplePrint:PrintWarning(...) end
function MDump(...) SimplePrint:SetFontColor(78, 233, 255) SimplePrint:Dump(...) end
function MDumpS(...) SimplePrint:SetFontColor(104, 255, 0) SimplePrint:Dump(..., true) end
function MDumpArray(...) SimplePrint:DumpArray(...) end

function MRPrint(...) SimplePrint:RunningRainbowPrint(..., 12, false) end
function MRPrintS(...) SimplePrint:RunningRainbowPrint(..., 1, false) end
